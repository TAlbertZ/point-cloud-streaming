...
def main():
	...
	fov_traces_obj.read_fov_traces_txt(params.FOV_TRACES_PATH, params.NUM_FRAMES_VIEWED)
	...
	qr_weights_obj.read_weights(params.QR_WEIGHTS_PATH_A, params.QR_WEIGHTS_PATH_B, params.PATH_RATE_VERSIONS, params.PATH_NUM_PTS_VERSIONS)
	...
	plot_figs_obj.plot_mean_size_over_tiles_per_frame(buffer_obj.mean_size_over_tiles_per_frame)
	plot_figs_obj.plot_mean_size_over_tiles_per_fov(buffer_obj.mean_size_over_tiles_per_fov)
	...
	plot_figs_obj.plot_num_valid_tiles_per_frame(buffer_obj.num_valid_tiles_per_frame)
	...
	plot_figs_obj.plot_success_download_rate_trace(buffer_obj.success_download_rate_trace)
