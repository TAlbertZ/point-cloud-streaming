...
class PlotFigs():
	...
	def plot_frame_quality_trace(self, frame_quality_lists):
		...
		legend = []
		plt.plot(frame_indexes, frame_quality_lists[params.BUFFER_LENGTH:], linewidth=2, color='red')
		...
		plt.title('Frame Quality of Longdress, Latency=%ds' %(params.TARGET_LATENCY // params.FPS), fontsize=40, fontweight='bold')
	...
	def plot_mean_tile_quality_per_frame_trace(self, frame_quality_lists, num_valid_tiles_per_frame):
		frame_indexes = range(len(frame_quality_lists) - params.BUFFER_LENGTH)
		legend = []
		...
		plt.plot(frame_indexes, np.array(frame_quality_lists[params.BUFFER_LENGTH:]) / np.array(num_valid_tiles_per_frame[params.BUFFER_LENGTH:]), linewidth=2, color='red')
		# legend.append('constant Wj, know BW')
		# plt.plot(frame_indexes, frame_quality_lists[1][params.TIME_GAP_BETWEEN_NOW_AND_FIRST_FRAME_TO_UPDATE * params.FPS:], linewidth=2, color='blue')
		legend.append('know BW')
		# plt.plot(frame_indexes, frame_quality_lists[2][params.TIME_GAP_BETWEEN_NOW_AND_FIRST_FRAME_TO_UPDATE * params.FPS:], linewidth=2, color='green')
		...
		# plt.legend(legend, fontsize=30, loc='best', ncol=1)
		plt.grid(linestyle='dashed', axis='y',linewidth=1.5, color='gray')
		plt.title('Mean Tile Quality per Frame of Longdress, Latency=%ds' %(params.TARGET_LATENCY // params.FPS), fontsize=40, fontweight='bold')
	...
	def plot_frame_size_trace(self, frame_size_list):
		...
		legend = []
		plt.plot(frame_indexes, np.array(frame_size_list[params.BUFFER_LENGTH:]) / 1000, linewidth=2, color='red')
		# legend.append('constant Wj, know BW')
		# plt.plot(frame_indexes, frame_quality_lists[1][params.TIME_GAP_BETWEEN_NOW_AND_FIRST_FRAME_TO_UPDATE * params.FPS:], linewidth=2, color='blue')
		legend.append('know BW')
		# plt.plot(frame_indexes, frame_quality_lists[2][params.TIME_GAP_BETWEEN_NOW_AND_FIRST_FRAME_TO_UPDATE * params.FPS:], linewidth=2, color='green')
		...
		# plt.legend(legend, fontsize=30, loc='best', ncol=1)
		plt.grid(linestyle='dashed', axis='y',linewidth=1.5, color='gray')
		plt.title('Frame Size of Longdress, Latency=%ds' %(params.TARGET_LATENCY // params.FPS), fontsize=40, fontweight='bold')
	...
	def plot_bandwidth_trace(self, plot_bw_trace, plot_predicted_bw_trace, bw_predict_accuracy_trace):
	...
	def plot_filtered_bandwidth_trace(self, plot_bw_trace, plot_predicted_bw_trace):
		timestamps_in_sec = range(len(plot_bw_trace) - params.TARGET_LATENCY // params.FPS + 1)
		legend = []
		...
		for i in range(len(timestamps_in_sec)):
			filtered_bw_trace.append(np.mean(plot_bw_trace[i : i + params.TARGET_LATENCY // params.FPS]))
			filtered_predicted_bw_trace.append(np.mean(plot_predicted_bw_trace[i : i + params.TARGET_LATENCY // params.FPS]))
		...
		plt.legend(legend, fontsize=30, loc='best', ncol=1)
		plt.grid(linestyle='dashed', axis='y',linewidth=1.5, color='gray')
		plt.title('Predicted/True %ds-Average Bandwidth Trace' %(params.TARGET_LATENCY // params.FPS), fontsize=40, fontweight='bold')
	...
	def plot_buffer_size_trace(self, buffer_size_trace_lists):
		...
		# plt.legend(legend, fontsize=30, loc='best', ncol=1)
		plt.grid(linestyle='dashed', axis='y',linewidth=1.5, color='gray')
		plt.title('Buffer Size Evolution of Longdress, Latency=%ds' %(params.TARGET_LATENCY // params.FPS), fontsize=40, fontweight='bold')
	...
	def plot_num_valid_tiles_per_frame(self, num_valid_tiles_per_frame):
		frame_indexes = range(len(num_valid_tiles_per_frame) - params.BUFFER_LENGTH)
		legend = []
		plt.plot(frame_indexes, num_valid_tiles_per_frame[params.BUFFER_LENGTH:], linewidth=2, color='red')
		# legend.append('constant Wj, know BW')
		# plt.plot(frame_indexes, frame_quality_lists[1][params.TIME_GAP_BETWEEN_NOW_AND_FIRST_FRAME_TO_UPDATE * params.FPS:], linewidth=2, color='blue')
		# legend.append('linear (flat) Wj, know BW')
		# plt.plot(frame_indexes, frame_quality_lists[2][params.TIME_GAP_BETWEEN_NOW_AND_FIRST_FRAME_TO_UPDATE * params.FPS:], linewidth=2, color='green')
	...
	def plot_num_max_tiles_per_frame(self, num_max_tiles_per_frame):
		frame_indexes = range(len(num_max_tiles_per_frame) - params.BUFFER_LENGTH)
		legend = []
		plt.plot(frame_indexes, num_max_tiles_per_frame[params.BUFFER_LENGTH:], linewidth=2, color='red')
		# legend.append('constant Wj, know BW')
		# plt.plot(frame_indexes, frame_quality_lists[1][params.TIME_GAP_BETWEEN_NOW_AND_FIRST_FRAME_TO_UPDATE * params.FPS:], linewidth=2, color='blue')
		# legend.append('linear (flat) Wj, know BW')
		# plt.plot(frame_indexes, frame_quality_lists[2][params.TIME_GAP_BETWEEN_NOW_AND_FIRST_FRAME_TO_UPDATE * params.FPS:], linewidth=2, color='green')
	...
	def plot_mean_size_over_tiles_per_frame(self, mean_size_over_tiles_per_frame):
		frame_indexes = range(len(mean_size_over_tiles_per_frame) - params.BUFFER_LENGTH)
		legend = []
		plt.plot(frame_indexes, mean_size_over_tiles_per_frame[params.BUFFER_LENGTH:], linewidth=2, color='red')
		# legend.append('constant Wj, know BW')
		# plt.plot(frame_indexes, frame_quality_lists[1][params.TIME_GAP_BETWEEN_NOW_AND_FIRST_FRAME_TO_UPDATE * params.FPS:], linewidth=2, color='blue')
		# legend.append('linear (flat) Wj, know BW')
		# plt.plot(frame_indexes, frame_quality_lists[2][params.TIME_GAP_BETWEEN_NOW_AND_FIRST_FRAME_TO_UPDATE * params.FPS:], linewidth=2, color='green')
	...
	def plot_mean_size_over_tiles_per_fov(self, mean_size_over_tiles_per_fov):
		frame_indexes = range(len(mean_size_over_tiles_per_fov) - params.BUFFER_LENGTH)
		legend = []
		plt.plot(frame_indexes, mean_size_over_tiles_per_fov[params.BUFFER_LENGTH:], linewidth=2)
		# legend.append('constant Wj, know BW')
		# plt.plot(frame_indexes, frame_quality_lists[1][params.TIME_GAP_BETWEEN_NOW_AND_FIRST_FRAME_TO_UPDATE * params.FPS:], linewidth=2, color='blue')
		# legend.append('linear (flat) Wj, know BW')
		# plt.plot(frame_indexes, frame_quality_lists[2][params.TIME_GAP_BETWEEN_NOW_AND_FIRST_FRAME_TO_UPDATE * params.FPS:], linewidth=2, color='green')
	...
	def plot_effective_rate_per_frame(self, effective_rate):
		...
		legend = []
		plt.plot(frame_indexes, effective_rate[params.BUFFER_LENGTH:], linewidth=2)
		# legend.append('constant Wj, know BW')
		# plt.plot(frame_indexes, frame_quality_lists[1][params.TIME_GAP_BETWEEN_NOW_AND_FIRST_FRAME_TO_UPDATE * params.FPS:], linewidth=2, color='blue')
		# legend.append('linear (flat) Wj, know BW')
		# plt.plot(frame_indexes, frame_quality_lists[2][params.TIME_GAP_BETWEEN_NOW_AND_FIRST_FRAME_TO_UPDATE * params.FPS:], linewidth=2, color='green')
	...
	def plot_tile_size_trace(self, tile_sizes_sol):
		...
		print(x, y, z)
		print(np.array(tile_sizes_sol[params.BUFFER_LENGTH:])[:, 1, 12, 1].nonzero())
		plt.plot(frame_indexes, np.array(tile_sizes_sol[params.BUFFER_LENGTH:])[:, 1, 12, 1], linewidth=2, color='red')
		# legend.append('constant Wj, know BW')
		# plt.plot(frame_indexes, frame_quality_lists[1][params.TIME_GAP_BETWEEN_NOW_AND_FIRST_FRAME_TO_UPDATE * params.FPS:], linewidth=2, color='blue')
		# legend.append('linear (flat) Wj, know BW')
		# plt.plot(frame_indexes, frame_quality_lists[2][params.TIME_GAP_BETWEEN_NOW_AND_FIRST_FRAME_TO_UPDATE * params.FPS:], linewidth=2, color='green')
	...
	def plot_success_download_rate_trace(self, success_download_rate_trace_lists):
		timestamps_in_sec = range(len(success_download_rate_trace_lists))
		legend = []

		plt.plot(timestamps_in_sec, success_download_rate_trace_lists, linewidth=2, color='red')
	...
	def plot_fov_prediction_accuracy_series(self, fov_predict_accuracy_trace):
		...
		num_valid_accuracy = (params.NUM_FRAMES_VIEWED - params.BUFFER_LENGTH) // (params.UPDATE_FREQ * params.FPS)
		###########################
		# x 	  y 	  z
		# pitch   yaw	 roll
		###########################
	...
	def plot_mean_fov_prediction_accuracy_for_every_buffer_pos(self, fov_predict_accuracy_trace):
		'''
			6 subplots for 6dof
		'''
		# pdb.set_trace()
