...
class QRWeights():
	...
	def __init__(self):
		...
		self.mean_a = 0
		self.mean_b = 0
		self.rate_versions = np.zeros((params.NUM_RATE_VERSIONS, params.NUM_FRAMES, params.NUM_TILES_PER_SIDE_IN_A_FRAME, params.NUM_TILES_PER_SIDE_IN_A_FRAME, params.NUM_TILES_PER_SIDE_IN_A_FRAME))
		self.num_pts_versions = np.zeros((params.NUM_RATE_VERSIONS, params.NUM_FRAMES, params.NUM_TILES_PER_SIDE_IN_A_FRAME, params.NUM_TILES_PER_SIDE_IN_A_FRAME, params.NUM_TILES_PER_SIDE_IN_A_FRAME))
		self.min_rates = np.zeros((params.NUM_FRAMES, params.NUM_TILES_PER_SIDE_IN_A_FRAME, params.NUM_TILES_PER_SIDE_IN_A_FRAME, params.NUM_TILES_PER_SIDE_IN_A_FRAME))

	def read_weights(self, path_a, path_b, path_rate_versions, path_num_pts_versions):
	...
	def give_every_tile_valid_weights(self):
		...
		self.min_rates = -self.qr_weights["b"] / self.qr_weights["a"] + 1e-3
		# pdb.set_trace()